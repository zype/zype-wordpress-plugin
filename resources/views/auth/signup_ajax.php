<div class="content-wrap zype_signup-wrapper user-action-wrap">
    <div class="zype_signup__heading">
        ...
        <div class="zype_signup__login">Already have an account, <a class="zype_signup__link"
                                                                    href="<?php echo home_url(Config::get('zype.login_url')) ?>/">Login</a>
        </div>
    </div>
    ...
    <form id="zype_signup_form_ajax" action="<?php echo get_site_url() ?>/signup_ajax/" class="user-form nice-form"
          method="post">
        ...
        <div class="zype_signup__fields">
            ...
            <div class="zype_signup__fields-group required-row">
                ...
                <input type="text" class="required" id="first-name"
                       name="name" <?php if (isset($zype_signup_name)) { ?> value=<?php echo $zype_signup_name; ?><?php } ?>>
            </div>
            <div class="zype_signup__fields-group required-row">
                <label for="email">Email</label>
                <input type="email" class="required-email" placeholder="name@company.com" id="email"
    ...
    <div class="zype_signup__note">By signing up you agree to the <a class="zype_signup__link"
                                                                     href="<?php echo get_permalink(get_page_by_path('terms-of-service')); ?>">Terms
            of Service</a> &amp; <a class="zype_signup__link"
                                    href="<?php echo get_permalink(get_page_by_path('privacy-policy')); ?>">Privacy
            Policy</a></div>
</div>
<script>
    (function ($) {
