          ...
          <form action="<?php echo admin_url('admin-ajax.php'); ?>" class="user-form nice-form validate-form" method="post">
            ...
            <div class="field-section">
              ...
              <div class="form-group user-profile-wrap__field">
                <input type="text" class="form-control user-profile-wrap__inp" id="full-name" name="name" value="<?php echo $consumer->name; ?>" placeholder="Full name">
              </div>
              <div class="form-group user-profile-wrap__field">
                <input type="email" class="form-control user-profile-wrap__inp" id="email" name="email" value="<?php echo $consumer->email; ?>" placeholder="Email">
              </div>
