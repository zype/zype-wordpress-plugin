  ...
  <div class="user-wrap">
    <div class="holder-main">
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="row">
            <p>Please take a moment to read the RSS section of our FAQ if you are unfamiliar with RSS Feeds &amp; Podcasts.</p>
          </div>
          <div class="row">
            <div class="col-sm-3">
            ...
            <div class="col-sm-8">
              ...
              <?php foreach($zype_rss_links as $zype_rss_name => $zype_rss_link){ ?>
                ...
                <?php } else { ?>
                  <p><a href="<?php echo $zype_rss_link['itunes']; ?>"><?php echo explode('%%', $zype_rss_name)[1]; ?></a></p>
                <?php } ?>
              <?php } ?>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-sm-8">
              <p>Click the link below if you are unsure... This feed will attempt to launch in your default podcast app if you have one.</p>
              <?php foreach($zype_rss_links as $zype_rss_name => $zype_rss_link){ ?>
                <?php if($zype_rss_name == 'default'){ ?>
                  <p><a href="<?php echo $zype_rss_link['feed']; ?>">Everything</a></p>
                <?php } else { ?>
                  <p><a href="<?php echo $zype_rss_link['feed']; ?>"><?php echo explode('%%', $zype_rss_name)[1]; ?></a></p>
                <?php } ?>
              <?php } ?>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-sm-8">
              <p>Use this feed if you know what you are doing or nothing else is working. This feed is for copying and pasting. Right click if you are on a desktop or click and hold on the link from a mobile device to bring up the auxiliary menu.</p>
                            <?php foreach($zype_rss_links as $zype_rss_name => $zype_rss_link){ ?>
                <?php if($zype_rss_name == 'default'){ ?>
                  <p><a href="<?php echo $zype_rss_link['http']; ?>">Everything</a></p>
                <?php } else { ?>
                  <p><a href="<?php echo $zype_rss_link['http']; ?>"><?php echo explode('%%', $zype_rss_name)[1]; ?></a></p>
                <?php } ?>
              <?php } ?>
            </div>
          </div>
