      ...
      <input type="hidden" name="action" value="zype_reset_password">
        ...
        <div class="field-section">
          ...
          <div class="form-group required-row user-profile-wrap__field">
            <input type="email" class="form-control required-email user-profile-wrap__inp" id="email" name="email" required="required" placeholder="Email">
          </div>

          <div class="form-group required-row user-profile-wrap__field">
            <input type="password" class="form-control required user-profile-wrap__inp" id="password" name="password" required="required" placeholder="New Password">
          </div>

          <div class="form-group required-row user-profile-wrap__field">
            <input type="password" class="form-control required user-profile-wrap__inp" id="password_confirmation" name="password_confirmation" required="required" placeholder="Confirm New Password">
          </div>
