                            ...
                            <div class="holder">
                                <?php foreach ($plans as $plan) { ?>
                                    <div class="zype-column-plans">
                                        ...
                                        <div class="zype-column-plan">
                                            <div class="zype-price-holder">$<?php echo $plan->amount; ?>
                                                /<?php if ($plan->interval_count > 1) {
                                                    echo $plan->interval_count . ' ';
                                                } ?><?php echo substr($plan->interval, 0, 2); ?><?php if ($plan->interval_count > 1) {
                                                    echo 's';
                                                } ?></div>
                                            <a href="<?php echo get_permalink() . "?zype_auth_type=checkout&planid=" . esc_attr($plan->_id) ?>"
