<div class="content-wrap zype_login-wrapper">
    ...
    <div class="user-wrap zype_form__login">
        <form id="zype_login_form_ajax" action="<?php echo get_site_url() ?>/login_ajax/" class="user-form nice-form"
              method="post">
            <div class="zype_login__form-fields">
                ...
                <div class="flex-nowrap">
                    ...
                    <a class="zype_form__link" href="<?php echo zype_url('profile'); ?>/forgot-password/">Forgot your
                        password?</a>
                </div>
                ...
                <p>Don’t have an account yet? <a class="zype_form__link" href="<?php echo zype_url('signup'); ?>/">Sign
                        Up</a></p>
            </div>
        </form>
