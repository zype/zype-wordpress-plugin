...
<div class="row guest-main">
  <div class="col-md-8">
      ...
      <div class="profile-holder">
        <div class="photo">
          <span data-picture data-alt="image description">
            ...
            <span data-src = "<?php echo $guest->thumbnail_url; ?>" data-media = "(max-width:1023px) and (-webkit-min-device-pixel-ratio:1.5), (max-width:1023px) and (min-resolution:144dpi)" ></span>
    ...
    <div class="ajax-area">
          ...
          <article>
            <div class="bg-stretch">
              <span data-picture data-alt="image description">
                ...
                <span data-src = "<?php echo $video->thumbnails[0]->url; ?>" data-media = "(max-width:1023px) and (-webkit-min-device-pixel-ratio:1.5), (max-width:1023px) and (min-resolution:144dpi)" ></span>
                <noscript><img src="<?php echo $video->thumbnails[0]->url; ?>" width="1442" height="400" alt="image description" ></noscript>
              </span>
            </div>
            <div class="text-col">
              <div class="meta"><time datetime="<?php echo date(DATE_W3C, strtotime($video->published_at?: $video->created_at)); ?>"><?php formatted_time($video->published_at?: $video->created_at); ?></time></div>
      ...
      <div class="load-more"><a class="btn-load" href="<?php zype_url('video'); ?>/?search=<?php echo urlencode($guest->title); ?>">more videos with <?php echo $guest->title; ?></a></div>
    </div>
  </div>
  <?php get_sidebar(); ?>
</div>
