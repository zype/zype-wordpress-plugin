...
<rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:media="http://search.yahoo.com/mrss/" version="2.0">
  <channel>
    ...
    <itunes:author xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd"><?php echo htmlspecialchars($feed_settings->author); ?></itunes:author>
    ...
    <itunes:image xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" href="<?php echo esc_attr($feed_settings->thumbnail_url); ?>"/>
    ...
    <?php foreach($items as $item){ ?>
      <?php if(isset($item->outputs) && $this->has_m4a($item)){ ?>
        <item>
          <title><?php echo htmlspecialchars($item->title); ?><?php if(isset($item->episode)){?> - Episode <?php echo htmlspecialchars($item->episode); } ?></title>
          ...
          <itunes:image xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" href="<?php echo esc_attr($item->thumbnail_url); ?>"/>
          ...
          <enclosure url="<?php echo esc_attr($this->the_m4a_url($item)); ?>" length="<?php echo esc_attr($this->the_file_size($item)); ?>" type="audio/m4a"/>
        </item>
      <?php } ?>
    <?php } ?>
