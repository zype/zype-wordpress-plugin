...
<p>Easily add playlists from your <a href="https://admin.zype.com/playlists" target="_blank">
Zype account</a> onto any 
page or post on your WordPress website using a playlist shortcode.
 Enter title keywords to search for playlists in your Zype library.
  You can also scroll down the page to find a playlist manually.</p>
<p>Once you’ve found the playlist you would like to embed, 
copy and paste the associated shortcode, including the [ ] brackets, 
onto any page or post on your website.</p>
...
Visitors can navigate through each playlist to access and play videos.</p>
