        ...
        <table class="form-table">
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="zype_saas_compatability" id="zype-saas-compatability" class="regular-checkbox"<?php echo $options['zype_saas_compatability'] ? 'checked="checked"' : ''; ?>>
