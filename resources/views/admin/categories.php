<div class="wrap zype-admin">
  ...
  <p>To enable an RSS Feed you must configure a corresponding RSS Feed Setting (Category Name and Category Value) in the <a href="https://admin.zype.com/" target="_blank">Zype Platform</a>.</p>
      ...
      <tbody>
        <?php if($categories){ ?>
          <?php foreach($categories as $i => $category){ ?>
            <tr><td colspan="5"><strong><?php echo $category->title; ?></strong></td></tr>
